function formatStudentCourses(student) {
  ...
  return {
    ...
    courses: studentCourseYears.map((studentCourseYear) => ({
      ...
      course_coordinator: `${studentCourseYear.student_course_course_year.course_year_course_coordinator?.prefix || ''}. ${studentCourseYear.student_course_course_year.course_year_course_coordinator?.forename || ''} ${studentCourseYear.student_course_course_year.course_year_course_coordinator?.surname || ''}`.trim(),
    }))
  }
}
