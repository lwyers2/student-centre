...
CREATE TABLE IF NOT EXISTS `course` (
  ...
  KEY `FK_course_course_level` (`course_level_id`) USING BTREE,
  KEY `fk_course_school_idx` (`school_id`) USING BTREE,
  CONSTRAINT `fk_course_course_level` FOREIGN KEY (`course_level_id`) REFERENCES `course_level` (`id`),
  CONSTRAINT `fk_course_school` FOREIGN KEY (`school_id`) REFERENCES `school` (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=5 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;

-- Data exporting was unselected.

-- Dumping structure for table student_marks.course_level
CREATE TABLE IF NOT EXISTS `course_level` (
  ...
  CONSTRAINT `fk_course_level_level` FOREIGN KEY (`level_id`) REFERENCES `level` (`id`)
