...
const AssignCourseYearsToUser = () => {
  ...
  return (
    <div className="max-w-4xl mx-auto p-4">
      <h2 className="text-3xl font-bold mb-6">Select Users to Add Courses</h2>
      ...
      <ul className="space-y-2">
        {filteredUsers.map((user) => (
          <li
            ...
            onClick={() => navigate(`/users/${user.id}/add-courses`)}
          >
...
export default AssignCourseYearsToUser
